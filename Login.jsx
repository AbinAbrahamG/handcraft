...
import Image1 from "../../assets/front/login.png"; // ✅ Importing images
import Image2 from "../../assets/front/signup.png";
import styles from "./Login.module.css"; // ✅ Corrected import path (relative)
...
const Login = () => {
  ...
  <a href="#" className={styles["social-icon"]}><i className="fab fa-google"></i></a>
  <a href="#" className={styles["social-icon"]}><i className="fab fa-linkedin-in"></i></a>
  <a href="#" className={styles["social-icon"]}><i className="fab fa-instagram"></i></a> {/* Instagram */}
